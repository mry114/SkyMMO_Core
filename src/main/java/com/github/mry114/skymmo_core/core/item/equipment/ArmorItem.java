...
public abstract class ArmorItem implements IEquipmentItem, IEquipmentMainStatus {
    ...
    public ArmorItem(int id, Component name, Rarity rarity, Material material, List<Component> lore) {
        this.id = id;
        this.name = name;
        this.rarity = rarity;

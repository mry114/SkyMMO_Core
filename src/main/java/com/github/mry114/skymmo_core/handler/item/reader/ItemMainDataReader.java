...
public class ItemMainDataReader implements IItemStatusReaderModule {
    @Override
    public @Nullable StatusContainer getStatus(ItemStack itemStack) {
        ...
        if (!(ItemRegistry.getById(pdc.get(ItemMainModuleKeys.PDC_ITEM_ID)) instanceof IEquipmentItem equipmentItem)) {
            return null;
        }
